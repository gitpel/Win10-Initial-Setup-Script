# Win10-Initial-Setup-Script (Active)

[Original source code](https://github.com/Disassembler0/Win10-Initial-Setup-Script) (author: Disassembler0) was archived so I decided to start maintaining the project (we'll see where we will go).

**The project issues\pull requests reviewed minimum ~once a week.**

p.s. I will try to reach Disassembler0 to update the README.md of his original project to add a link to this fork to avoid separation of developers/users of the project
